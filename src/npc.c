 ...
 */
#define	UNS_CITY_VALUE	10	/* If there is an under-defended City the
				 * value is 500 */
...
getdstatus()
{
  ...
  int             X,
                  Y;
  int             svhostile,
                  hostile;	/* chance nation will react hostile */
