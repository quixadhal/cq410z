...
char           *names[] = {	/* must end in single character name */
  "aghast", "agony", "anger", "anguish", "misery", "suffer", "torture",
  "pain", "death", "gasp", "cry", "weep", "scream", "demise", "grim",
  "gore", "fester", "blood", "bone", "howl", "terror", "shock", "shriek",
  "screech", "yowl", "cadaver", "corpse", "slice", "carve", "rip",
  "burn", "crumble", "sting", "screwed", "fucked", "lost", "gone",
  "filth", "pus", "scab", "whipped", "beaten", "blasted", "dust",
  "rout", "smear", "trounce", "flambe", "smother", "sicken", "choke",
  "strangle", "garrotte", "nuked", "squish", "plaster", "argh", "X"
};
...
randomevent()
{
  int             percent,
                  ...
                  y;
  int             done,
                  holdval;	/* if 1 then event happened */
  long            longval;
  long            newpower;
